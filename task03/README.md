...
## Скрипт
- Скрипт с именем `meme_generator.py` получает в `stdin` две строки, соответственно: верхний и нижний текст. 
- Скрипт берет картинку из файла `image.png`, помещает верхний текст в верхней части картинки, а нижний - в нижней части.
