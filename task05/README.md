...
Затем вы открываете Pull Request из вашего репозитория в наш, в котором вы назначаете своего преподавателя рецензентом (reviewer) и проходите ревью. Для этого нужно в описании упомянуть нас(@edgarzhavoronkov или @yeputons соответственно) 
